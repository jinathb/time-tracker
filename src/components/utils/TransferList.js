...
export default function TransferList({ leftList, leftTitle, rightList,rightTitle,setRightList,setLeftList }) {
  ...
  const handleCheckedRight = () => {
    ...
    changeParentLists(tempRight,tempLeft);
  };
  ...
  const changeParentLists=(rightL,leftL)=>{
    setRightList(rightL);
    setLeftList(leftL);
  }
